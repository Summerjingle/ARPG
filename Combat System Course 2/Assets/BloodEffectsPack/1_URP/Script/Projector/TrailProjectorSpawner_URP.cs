...
{
    public class TrailProjectorSpawner_URP : MonoBehaviour
    {
        ...
        void SpawnProjector()
        {
            ...
            ProjectorSpawner_URP spawner = projector_spawner.GetComponent<ProjectorSpawner_URP>();
            spawner.startSize_min = startSize_min;
            spawner.startSize_max = startSize_max;
            spawner.ResetAndInitialize(renderingLayerMask);
